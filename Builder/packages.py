...
BASE_PACKAGES = [
    ...
    "fish", "dpkg", "gcc", "gedit", "git", "gnu-netcat", "htop", "btop", "lxappqearance",
    ...
    "ttf-iosevka-nerd", "flameshot", "ghex", "chromium", "obsidian", "telegram-desktop", "python-pip", "docker"
]

DEV_PACKAGES = [
    "nmap", "hashcat", "perl-image-exiftool", "aircrack-ng"
]

AUR_PACKAGES = [
    "gobuster", "steghide", "binwalk"
]
